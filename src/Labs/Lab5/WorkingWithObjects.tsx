...
export default function WorkingWithObjects() {
    ...
    const [module, setModule] = useState({
        id: "id_module", name: "New Module",
        description: "Create a module on your own",
  ...
  return (
    <div id="wd-working-with-objects">
      ...
      <a id="wd-update-assignment-completed"
         className="btn btn-primary float-end"
         href={`${ASSIGNMENT_API_URL}/checked/${assignment.completed}`}>
        Update Completed
      </a>
      <input type = "checkbox" className="form-control w-75" id="wd-assignment-completed"
        onChange={(e) =>
